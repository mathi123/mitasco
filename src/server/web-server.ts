...
export class WebServer{
    ...
    public configureRoute(type:RouteType, entity:string,
        ...
        switch(type){
            case RouteType.GET: this._app.get(route, controller); break;
            case RouteType.POST: this._app.post(route, controller); break;
            case RouteType.PUT: this._app.put(route, controller); break;
            case RouteType.DELETE: this._app.delete(route, controller); break;
            default: throw new Error();
        }

        console.info(`route ${route} is up`);
    }
